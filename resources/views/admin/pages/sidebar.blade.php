 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
     ...
     <div class="sidebar">
      ...
      with font-awesome or any other icon font library -->
                 ...
                 <!-- Products -->
                 <li class="nav-item has-treeview @yield('product_create_menu_open') @yield('product_list_menu_open')">
                     <a href="#" class="nav-link @yield('product_create_menu_active') @yield('product_list_menu_active')">
