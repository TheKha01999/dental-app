                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" action="{{ route('admin.branchs.store') }}" method="post"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" id="address" cols="30" rows="10" placeholder="Enter address" class="form-control">{{ old('address') }}</textarea>
...
@section('branch_create_menu_open')
    menu-open
@endsection
