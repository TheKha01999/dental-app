                            ...
                            <form role="form" action="{{ route('admin.services.update', ['service' => $service->id]) }}"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="slug" type="text" value="{{ $service->slug }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" name="status">
                                            ...
                                            <option {{ $service->status == '1' ? 'selected' : '' }} value="1">Show
                                            </option>
                                            <option {{ $service->status == '0' ? 'selected' : '' }} value="0">Hide
                                            </option>
                                        </select>
                                        @error('status')
                                            <div class="text-danger mt-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" name="service_categories_id">
                                            ...
                                            @foreach ($serviceCategories as $serviceCategory)
                                                <option
                                                    {{ $service->service_categories_id == $serviceCategory->id ? 'selected' : '' }}
